...
from ga4_remote_mcp.ga.tools.reporting.metadata import (
...
async def run_report(
    ...
    Args:
        property_id: Property ID as string (numeric or ``properties/...``).
          String-only in the signature for MCP tools so JSON Schema avoids
          int/str unions (e.g. n8n + Vertex Gemini tool schema conversion).
